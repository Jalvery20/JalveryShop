...
import { getProductDetails} from '../../slices/product/productDetails'
import { updateProduct,clearErrors, UpdateProductReset } from '../../slices/product/newProduct';
...
const UpdateProduct = () => {
    ...
    useEffect(() => {
      ...
      }, [updateError,product,id,dispatch,toast,navigate,error,isUpdated])
              ...
              <div className='form-group'>
                <label>Images</label>
                    ...
                    {oldImages && oldImages.map(img=>(
                        <img height="52" width="55" key={img} src={img.url} alt={img.url}  className="mt-3 mr-2" />
                    ))}
